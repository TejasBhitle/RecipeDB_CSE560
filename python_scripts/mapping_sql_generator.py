...
def create_recipe_ingredient():
    sql = "INSERT INTO recipeingredientpivot(ingredient_id_fk, recipe_id_fk, num_of_units) VALUES" #+ ( 1, 1, 1) +";"
...
def create_ingredient_nutrient():
    sql = "INSERT INTO ingredientnutrientpivot(ingredient_id_fk, nutrient_id_fk, quantity) VALUES " #+ ( 1, 1, 1) +";"
...
def create_recipe_label():
    sql = "INSERT INTO recipelabelspivot(recipe_id_fk, label_id_fk) VALUES " #+ ( 1, 1, 1) +";"
