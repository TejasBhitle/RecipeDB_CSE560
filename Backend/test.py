...
if __name__ == '__main__':
    ...
    for d in dda:
        ...
        url = recipe['uri']
        print(
            "INSERT INTO recipe(name, description, prep_time, meal_type, servings, img_url, url) VALUES ('{recipename}', '{description}', {preptime}, '{mealtype}', {serving}, '{imageurl}', '{url}');".format(
